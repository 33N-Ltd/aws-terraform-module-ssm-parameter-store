...
variable "read_parameter_map" {
  type        = "map"
  description = "Map of parameters to read from SSM. Keys of the map will be used in returning output."
  default     = {}
}
